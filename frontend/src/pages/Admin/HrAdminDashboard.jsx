  ...
  if (loading) {
    return (
      <div className="loader-screen">
        ...
        <style>{`
          .loader-screen{min-height:100vh;display:grid;place-items:center;background:#f8fafc;padding:20px;font-family:'DM Sans',system-ui,-apple-system,Segoe UI,Roboto,Arial;color:#0f172a;}
    ...
    <div className="hr-dashboard">
      ...
      <style>{`
        ...
        .hr-dashboard{
          ...
          /* Kill the dark body background behind the dashboard */
          box-shadow: 0 0 0 100vmax #f8fafc;
          clip-path: inset(0 -100vmax);
        }

        /* Override any dark root leaking from index.css */
        .hr-dashboard h1, .hr-dashboard h2, .hr-dashboard h3, .hr-dashboard h4,
        .hr-dashboard p, .hr-dashboard span, .hr-dashboard label,
        .hr-dashboard td, .hr-dashboard th, .hr-dashboard div {
          color: inherit;
        }

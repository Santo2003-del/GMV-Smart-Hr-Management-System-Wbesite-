      ...
      <div className="dark-reg-container slide-up">
        ...
        <div className="right-panel">
          ...
          <form onSubmit={handleSubmit} className="form-content">
            ...
            {/* SECTION 1: Face Biometrics (compact) */}
            <div className="form-section">
              <h3 className="section-title">Face Biometrics</h3>
              <p className="section-sub">Quick face scan for attendance & access.</p>
              ...
              <div className="camera-box">
                {modelLoading ? (
                  ...
                  <div className="scanned-result">
                    ...
                    <p className="success-text">Face Captured ✓</p>
                  ...
                  <div className="start-camera-state">
                    ...
                    <h4>Scan Face</h4>
                    <p>Used for daily attendance.</p>
                    <button type="button" className="submit-btn" style={{ marginTop: '12px', width: 'auto', padding: '10px 24px' }} onClick={() => setIsCameraOpen(true)}>
                      Start Camera
                    </button>
                  </div>
                )}
